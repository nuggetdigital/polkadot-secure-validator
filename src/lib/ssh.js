...
module.exports = {
  keys: () => {
    if(!validatorSshPrivateKeyPath) {
      console.log(chalk.red('Please, export the path of the file with the private SSH key you want to use on validators as the environment variable SSH_PRIVATE_KEY'));
      process.exit(-1);
    }
